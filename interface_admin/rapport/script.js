...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //Fonction pour récupérer la liste des rapports disponibles
    ...
    //Fonction pour afficher la liste des rapports dans la page
    function renderList() {
    ...
    //Fonction pour convertir une taille en octets en format lisible
    ...
    //Fonction pour charger le contenu d'un rapport sélectionné
    ...
    //Fonction pour télécharger le rapport actuellement affiché
