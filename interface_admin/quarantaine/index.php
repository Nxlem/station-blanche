...
//Endpoint local qui traite les actions AJAX de restauration ou suppression
            ...
            if ($action === 'restore') {
                ...
                if (!is_dir($restore_dir)) {
                    if (!@mkdir($restore_dir, 0755, true)) {
                        ...
                        error_log("[quarantaine] Impossible de créer le dossier: $restore_dir");
                    }
                }
                ...
                if (empty($response['message'])) {
                    if (rename($target_path, $restore_path)) {
                        ...
                        error_log("[quarantaine] Impossible de déplacer $target_path vers $restore_path");
                    }
                }
