...
//Fonction pour enregistrer une action administrateur dans les logs
...
//Fonction pour exporter la liste des utilisateurs en fichier CSV
...
//Fonction pour découper une ligne CSV en gardant les valeurs entre guillemets
...
//Fonction pour transformer le contenu d'un CSV en liste d'utilisateurs
...
//Fonction pour préparer les données d'un utilisateur avant l'import
...
//Fonction pour importer des utilisateurs depuis un fichier CSV
...
//Fonction pour afficher le formulaire d'ajout ou de modification d'utilisateur
...
//Fonction pour cacher le formulaire utilisateur
function hideForm() {
    userFormSection.style.display = 'none';
}

//Fonction pour enregistrer un utilisateur créé ou modifié
...
//Fonction pour charger un utilisateur dans le formulaire de modification
